...
// taken from https://stackoverflow.com/a/77027650
...
fun rememberPermissionsState(
    ...
    val launcher = rememberLauncherForActivityResult(
        ...
        when {
            !permissionsResult.containsValue(false) -> onGrantedAction()
            ...
            else -> onDeniedAction(permissionsResult.filter { !it.value }.keys.toList())
        }
    }
...
class MultiplePermissionsState(
    ...
    private val permissions: List<PermissionState> = mutablePermissions

    private val revokedPermissions: List<PermissionState> by derivedStateOf {
